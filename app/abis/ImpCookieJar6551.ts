export const ImplCookieJar6551 = [
  {
    anonymous: false,
    inputs: [
      {
      ...
      { indexed: false, internalType: "string", name: "_uid", type: "string" },
    ],
    name: "GiveCookie",
    type: "event",
  },
  ...
  {
    inputs: [{ internalType: "address", name: "allowed", type: "address" }],
    name: "allowList",
  ...
  {
    inputs: [
      { internalType: "string", name: "_cookieUid", type: "string" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bool[]", name: "_isAlloweds", type: "bool[]" },
    ],
    name: "batchAllowList",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_cookieAmount", type: "uint256" },
